...
>
type _InvitationAcceptBody = AssertNonNever<
  paths['/api/v1/users/invitations/accept']['post']['requestBody']
>
...
>
type _InternalEmailWebhook202Realised = AssertNonNever<
  paths['/api/v1/_internal/email/webhook']['post']['responses']['202']
>
