...
- [x] 82-03-PLAN.md — PWA LoyaltyBalanceCard + BonusHistorySheet behind clubBonuses flag + query hooks + Vitest
...
- [x] 83-03-PLAN.md — PWA CheckoutSheet real-balance redemption wiring + clubBonuses flag ON + additive openapi.json/schema.d.ts regen
