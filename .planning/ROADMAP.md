...
- [ ] 68-01-PLAN.md — DB foundation: OtpCode.client_id + XOR CHECK + client_refresh_tokens table (Alembic 0043/0044)
- [ ] 68-02-PLAN.md — Client JWT + cookie primitives in security.py (decode_client_token aud=client, cc_client_* cookies)
...
| 68. Client Auth Foundation | v2.0 | 0/6 | Planned | - |
