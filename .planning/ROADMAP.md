...
Plans:
- [ ] 81-01-weekly-activity-endpoint-PLAN.md — GET /client/activity/weekly: ClientWeeklyActivityItem schema + raw-SQL fetch_weekly_activity over visits.gym_date + 7-day zero-fill service + endpoint + golden TZ unit test + integration/IDOR tests (WACT-01)
...
| 81. Weekly Activity + PWA Flag Flips + OpenAPI Handoff | 0/3 | Planned | - |
