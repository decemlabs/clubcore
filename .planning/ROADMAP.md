...
**Plans:** 5 plans
  - [ ] 25-01-PLAN.md (wave 1) — Migration 0008_freeze + ORM model + transitions map + exception classes (MEM-FRZ-01/02/03)
  - [ ] 25-02-PLAN.md (wave 2, depends on 25-01) — Repository helpers: insert/get/compute freeze periods + list-view subquery + Postgres-backed compute test (MEM-FRZ-02/03/EP-03)
  - [ ] 25-04-PLAN.md (wave 3, depends on 25-01, 25-02) — Schemas + Router: FROZEN enum + 4 freeze fields + POST /freeze + /unfreeze (MEM-FRZ-01/06/EP-01/02/03) — runs BEFORE service plan so MembershipResponse fields exist before projection
