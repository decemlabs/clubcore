# Requirements Archive: v1.7 Online Payments + 54-ФЗ

**Archived:** 2026-05-24
**Status:** SHIPPED

**Outcome:** 48/51 requirements delivered and validated. The remaining 3 are **operator-credential-gated** and acknowledged as deferred at milestone close (not functional gaps):
- **CARRY-01** (DEFER-46-01) — live RU email-deliverability probe; needs real Yandex Postbox API key + owner RU aliases. Probe script + scaffolding ready.
- **CARRY-02** (DEFER-46-02) — owner formal countersign of 15 `LOCKED_EMAIL_TEMPLATES` (visual sanity check, no content edits).
- **VER-03** — ЮKassa sandbox owner-recorded end-to-end walkthrough per D-04. VER-01/02/04/05 technically verified (Phase 53: 16/16 new tests pass, 0/5 inline regressions).

> The in-line `- [ ]` checkboxes below reflect the planning-time state and were not flipped per-phase during execution; the **Traceability table at the bottom is the authoritative final status.** All 7 phases are disk-complete (47/47 plans).
...
| REQ-ID | Phase | Status |
|---|---|---|
| INFRA-34 | Phase 47 | Complete |
| INFRA-35 | Phase 47 | Complete |
| INFRA-36 | Phase 47 | Complete |
| INFRA-37 | Phase 47 | Complete |
| INFRA-38 | Phase 47 | Complete |
| INFRA-39 | Phase 47 | Complete |
| INFRA-40 | Phase 47 | Complete |
| INFRA-41 | Phase 47 | Complete |
| ADAPTER-01 | Phase 48 | Complete |
| ADAPTER-02 | Phase 48 | Complete |
| ADAPTER-03 | Phase 48 | Complete |
| ADAPTER-04 | Phase 48 | Complete |
| ADAPTER-05 | Phase 48 | Complete |
| ADAPTER-06 | Phase 48 | Complete |
...
| NOTIFY-01 | Phase 52 | Complete |
| NOTIFY-02 | Phase 52 | Complete |
| NOTIFY-03 | Phase 52 | Complete |
| NOTIFY-04 | Phase 52 | Complete |
| NOTIFY-05 | Phase 52 | Complete |
| CARRY-01 | Phase 52 | Deferred (operator — DEFER-46-01, needs Yandex Postbox creds) |
| CARRY-02 | Phase 52 | Deferred (operator — DEFER-46-02, owner countersign) |
| VER-01 | Phase 53 | Complete (verified) |
| VER-02 | Phase 53 | Complete (verified) |
| VER-03 | Phase 53 | Deferred (operator — ЮKassa sandbox walkthrough per D-04) |
| VER-04 | Phase 53 | Complete (verified — 0/5 inline regressions) |
| VER-05 | Phase 53 | Complete (DEFER-46-03 closed) |
