...
**Current focus:** Phase 117 — OpenAPI Handoff + Milestone Gate
...
| 260616-2lx | v3.2 browser-UAT gap — make Phase 116 staff chat inbox reachable (router lazy-loads MessagesPage out of the FND-04 ComingSoon block + re-add «Сообщения» nav, both roles, reception read-only) | 2026-06-16 | 160d9d88 | Verified (typecheck+lint+410 tests green; live-browser: owner list/open/reply + reception read-only, zero console errors) | [260616-2lx-staff-inbox-route](./quick/260616-2lx-staff-inbox-route/) |
