"""Regression guard for HandlerContext shape (Phase 20 AUTH-TG-07; Phase 40 BOT-04).
...
END to preserve positional construction compatibility.
"""
...
def test_handler_context_double_construction_keeps_all_seven_fields() -> None:
    ...
    require live event loop + Redis). Proves all 7 kwargs appear at the
    ...
    # Worker constructs HandlerContext with these 7 kwargs
    # (D-40-08 + D-40-04 + D-40-06).
