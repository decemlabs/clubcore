...
BOOKING_CONFIRMED_DM: Final[str] = "Здравствуйте, {client_name}! Ваша запись подтверждена: тренер {trainer_name}, {slot_start_msk} (МСК). Ждём вас в зале!"  # noqa: E501, RUF001  # OWNER-COPY-LOCK pending — see 39-01-SUMMARY.md
BOOKING_CANCELLED_BY_CLIENT_DM: Final[str] = "Здравствуйте, {client_name}! Ваша запись к тренеру {trainer_name} на {slot_start_msk} (МСК) отменена по вашей просьбе. Будем рады видеть вас снова — обратитесь к администратору, чтобы записаться заново."  # noqa: E501, RUF001  # OWNER-COPY-LOCK pending — see 39-01-SUMMARY.md
BOOKING_CANCELLED_BY_OWNER_DM: Final[str] = "Здравствуйте, {client_name}! К сожалению, ваша запись к тренеру {trainer_name} на {slot_start_msk} (МСК) отменена. Приносим извинения за неудобства — администратор поможет подобрать другое время."  # noqa: E501, RUF001  # OWNER-COPY-LOCK pending — see 39-01-SUMMARY.md
BOOKING_REMINDER_24H_DM: Final[str] = "Здравствуйте, {client_name}! Напоминаем о вашей записи: завтра, {slot_start_msk} (МСК), вас ждёт тренер {trainer_name}. Пожалуйста, не опаздывайте."  # noqa: E501, RUF001  # OWNER-COPY-LOCK pending — see 39-01-SUMMARY.md
_BOT_BOOK_DENIED_DM: Final[str] = "Сейчас бронирование недоступно. Пожалуйста, свяжитесь с администратором — он подскажет ближайшее свободное время."  # noqa: E501, RUF001  # OWNER-COPY-LOCK pending — see 39-01-SUMMARY.md  # NOTIFY-02 anti-oracle: NO placeholders, NO failure-cause disclosure (C-12)
