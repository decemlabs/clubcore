...
class ProfileUpdateRequest(BackendSchemaBase):
    """PATCH /api/v1/auth/me request body (PROF-01).
...
class ChangePasswordRequest(BackendSchemaBase):
    """POST /api/v1/auth/change-password request body (PROF-02).
