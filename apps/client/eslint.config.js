...
export default tseslint.config(
  {
    ...
    // D-71-09: all net-new placeholder screens have graduated (Phases 86-98).
    //   The dedicated per-screen no-restricted-paths blocks have been removed.
    //   All graduated screens now import freely via @/data alias.
    ignores: [
      'dist',
      'node_modules',
      'coverage',
      // Pre-existing JSX/JS screens and utilities (D-69-06 allowJs ramp).
      // All net-new screens have graduated (Phases 86–98) and import via @/data.
      'src/**/*.jsx',
      'src/**/*.js',
    ],
  },
