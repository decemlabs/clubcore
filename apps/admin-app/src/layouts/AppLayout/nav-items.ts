...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Отчёты',       to: ROUTES.reports,    icon: BarChart3, ownerOnly: true, ownerResource: 'reports' },
      { label: 'Финансы',      to: ROUTES.finance,    icon: Banknote,  ownerOnly: true, ownerResource: 'finance' },
