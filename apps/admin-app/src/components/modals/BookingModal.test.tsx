...
vi.mock('@/features/clients/api', () => ({
  useClients: vi.fn(() => ({
    data: {
      items: [
        { id: 'client-1', fullName: 'Иван Иванов', phone: '+7 999 000 0000' },
      ],
      total: 1,
      page: 1,
      pageSize: 20,
      ...
      items: [
        {
          ...
          clientId: 'client-1',
          status: 'active',
          planSnapshot: { id: 'plan-1', name: 'Пакет 10 занятий', sessionCount: 10, priceKopecks: 50000, active: true, createdAt: '2026-01-01T00:00:00Z' },
          sessionsTotal: 10,
          sessionsUsed: 3,
          sessionsRemaining: 7,
          amountKopecks: 50000,
  ...
  return {
    useCreateBooking: vi.fn(() => ({
      mutateAsync: vi.fn().mockRejectedValue(
        new FakeApiError('slot_already_booked', 'Слот уже занят')
      ),
      isPending: false,
    })),
