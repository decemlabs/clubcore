...
export const routeRegistry: readonly RouteEntry[] = [
  { path: ROUTES.dashboard,  resource: 'dashboard',        label: 'Главная',      icon: 'LayoutDashboard', navKey: 'home' },
  { path: ROUTES.clients,    resource: 'clients',           label: 'Клиенты',      icon: 'Users',           navKey: 'clients' },
  { path: ROUTES.schedule,   resource: 'schedule',          label: 'Расписание',   icon: 'CalendarDays',    navKey: 'schedule' },
  { path: ROUTES.plans,      resource: 'membership-plans',  label: 'Абонементы',   icon: 'CreditCard',      navKey: 'membershipPlans' },
  { path: ROUTES.trainers,   resource: 'trainers',          label: 'Тренеры',      icon: 'UserCog',         navKey: 'staff' },
  { path: ROUTES.cashbox,    resource: 'payments',          label: 'Касса',        icon: 'Wallet',          navKey: 'memberships' },
