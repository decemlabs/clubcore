...
function resetMocks() {
  mockUsePayrollConfig.mockReturnValue(
    PENDING_QUERY as unknown as ReturnType<typeof usePayrollConfig>,
  );
  mockUseSetPayrollConfig.mockReturnValue(
    PENDING_MUTATION as unknown as ReturnType<typeof useSetPayrollConfig>,
  );
  mockUseAccrualPreview.mockReturnValue(
    PENDING_QUERY as unknown as ReturnType<typeof useAccrualPreview>,
  );
  mockUseRunAccrual.mockReturnValue(
    PENDING_MUTATION as unknown as ReturnType<typeof useRunAccrual>,
  );
  ...
  mockUseMarkAccrualPaid.mockReturnValue(
    PENDING_MUTATION as unknown as ReturnType<typeof useMarkAccrualPaid>,
  );
}
