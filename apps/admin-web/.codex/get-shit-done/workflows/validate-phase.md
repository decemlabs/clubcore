...
```
Task(
  prompt="Read /Users/andre/Workspace/Development/SportZal/adminka/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/andre/Workspace/Development/SportZal/adminka/.codex/get-shit-done/templates/VALIDATION.md`
