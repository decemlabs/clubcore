...
- **Global scope**: `/Users/andre/Workspace/Development/SportZal/adminka/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/andre/Workspace/Development/SportZal/adminka/.codex/notes/`)
...
2. Glob `/Users/andre/Workspace/Development/SportZal/adminka/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/andre/Workspace/Development/SportZal/adminka/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/andre/Workspace/Development/SportZal/adminka/.codex/notes/` — works in any directory
