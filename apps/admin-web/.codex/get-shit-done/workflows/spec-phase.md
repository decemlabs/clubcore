...
```bash
INIT=$(node "/Users/andre/Workspace/Development/SportZal/adminka/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/andre/Workspace/Development/SportZal/adminka/.codex/get-shit-done/templates/spec.md.
