...
- Usage: Reference from command with `@/Users/andre/Workspace/Development/SportZal/adminka/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/andre/Workspace/Development/SportZal/adminka/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/andre/Workspace/Development/SportZal/adminka/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
