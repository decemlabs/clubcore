...
```bash
node "/Users/andre/Workspace/Development/SportZal/adminka/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `/Users/andre/Workspace/Development/SportZal/adminka/.claude/get-shit-done/templates/retrospective.md`.
