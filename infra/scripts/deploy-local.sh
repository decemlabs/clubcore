...
log "      Importing clubcore/admin:${TAG} ..."
k3d image import "clubcore/admin:${TAG}" -c "${CLUSTER_NAME}"
log "      Importing clubcore/client:${TAG} ..."
k3d image import "clubcore/client:${TAG}" -c "${CLUSTER_NAME}"
