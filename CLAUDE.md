...
- **Frontend integrity**: `apps/admin-web` — удалён в Phase 105; `apps/admin` — активный staff frontend (React 19 + TanStack Router, полностью подключён к backend API в v3.0)
